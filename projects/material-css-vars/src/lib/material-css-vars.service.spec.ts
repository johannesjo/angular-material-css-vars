...
describe('MaterialCssVarsService', () => {
  ...
  describe('setPrimaryColor', () => {
    ...
    it('should update the CSS variables', () => {
      ...
      expect(spy).toHaveBeenCalledWith(jasmine.anything(), '--palette-primary-500', 'rgb(17, 68, 170)', RendererStyleFlags2.DashCase);
    });
  });
  ...
  describe('setAccentColor', () => {
    ...
    it('should update the CSS variables', () => {
      ...
      expect(spy).toHaveBeenCalledWith(jasmine.anything(), '--palette-accent-500', 'rgb(17, 170, 68)', RendererStyleFlags2.DashCase);
    });
  });
  ...
  describe('setWarnColor', () => {
    ...
    it('should update the CSS variables', () => {
      ...
      expect(spy).toHaveBeenCalledWith(jasmine.anything(), '--palette-warn-500', 'rgb(170, 17, 68)', RendererStyleFlags2.DashCase);
    });
  });
  ...
  it('should set a variable', () => {
    ...
    expect(spy).toHaveBeenCalledWith(jasmine.anything(), '--dark-accent-text', 'rgb(0, 0, 0)', RendererStyleFlags2.DashCase);
  });
